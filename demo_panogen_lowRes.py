...
# ==========================================================================================
# This script provides a low-resolution and faster alternative for panorama generation.
# It can generate a 360-degree panoramic image from either a text prompt or a single
# input image.
#
# Key Modifications for Performance:
# - Default Resolution: The default output resolution is reduced to 1024x512 pixels
#   to decrease VRAM usage and speed up generation time.
# - Configurable Resolution: Users can override the default resolution by using the
#   --width and --height command-line arguments.
#
# Usage (Text-to-Panorama):
# python demo_panogen_lowRes.py --prompt "a beautiful sunset over the mountains"
#
# Usage (Image-to-Panorama):
# python demo_panogen_lowRes.py --image_path /path/to/your/image.png --prompt "a sunny day"
# ==========================================================================================
import os
import torch
import numpy as np 
...
class Text2PanoramaDemo:
    def __init__(self, width=1024, height=512):
        # MODIFICATION: Reduced default resolution for lower resource consumption
        self.height = height
        self.width = width
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Text/Image to Panorama Demo (Low Resolution)")
    ...
    # MODIFICATION: Added arguments to control output resolution
    parser.add_argument("--width", type=int, default=1024,
                        help="Width of the output panorama")
    parser.add_argument("--height", type=int, default=512,
                        help="Height of the output panorama")
    ...
    if args.image_path is None:
        ...
        demo_T2P = Text2PanoramaDemo(width=args.width, height=args.height)
        ...
        demo_I2P = Image2PanoramaDemo(width=args.width, height=args.height)
